...
kobuki_ros_interfaces__msg__RobotStateEvent__create()
{
  ...
  kobuki_ros_interfaces__msg__RobotStateEvent * msg = (kobuki_ros_interfaces__msg__RobotStateEvent *)allocator.allocate(sizeof(kobuki_ros_interfaces__msg__RobotStateEvent), allocator.state);
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__msg__RobotStateEvent__Sequence__init(kobuki_ros_interfaces__msg__RobotStateEvent__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__msg__RobotStateEvent *)allocator.zero_allocate(size, sizeof(kobuki_ros_interfaces__msg__RobotStateEvent), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  kobuki_ros_interfaces__msg__RobotStateEvent__Sequence * array = (kobuki_ros_interfaces__msg__RobotStateEvent__Sequence *)allocator.allocate(sizeof(kobuki_ros_interfaces__msg__RobotStateEvent__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
