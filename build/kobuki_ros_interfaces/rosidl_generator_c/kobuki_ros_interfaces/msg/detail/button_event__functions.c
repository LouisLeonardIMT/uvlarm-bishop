...
kobuki_ros_interfaces__msg__ButtonEvent__create()
{
  ...
  kobuki_ros_interfaces__msg__ButtonEvent * msg = (kobuki_ros_interfaces__msg__ButtonEvent *)allocator.allocate(sizeof(kobuki_ros_interfaces__msg__ButtonEvent), allocator.state);
  if (!msg) {
    return NULL;
  }
...
kobuki_ros_interfaces__msg__ButtonEvent__Sequence__init(kobuki_ros_interfaces__msg__ButtonEvent__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kobuki_ros_interfaces__msg__ButtonEvent *)allocator.zero_allocate(size, sizeof(kobuki_ros_interfaces__msg__ButtonEvent), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  kobuki_ros_interfaces__msg__ButtonEvent__Sequence * array = (kobuki_ros_interfaces__msg__ButtonEvent__Sequence *)allocator.allocate(sizeof(kobuki_ros_interfaces__msg__ButtonEvent__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
