  ...
  kobuki_ros_interfaces__action__AutoDocking_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kobuki_ros_interfaces__action__AutoDocking_Goal * data =
      (kobuki_ros_interfaces__action__AutoDocking_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kobuki_ros_interfaces__action__AutoDocking_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kobuki_ros_interfaces__action__AutoDocking_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  kobuki_ros_interfaces__action__AutoDocking_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kobuki_ros_interfaces__action__AutoDocking_Result * data =
      (kobuki_ros_interfaces__action__AutoDocking_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kobuki_ros_interfaces__action__AutoDocking_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kobuki_ros_interfaces__action__AutoDocking_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  kobuki_ros_interfaces__action__AutoDocking_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kobuki_ros_interfaces__action__AutoDocking_Feedback * data =
      (kobuki_ros_interfaces__action__AutoDocking_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kobuki_ros_interfaces__action__AutoDocking_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kobuki_ros_interfaces__action__AutoDocking_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request * data =
      (kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kobuki_ros_interfaces__action__AutoDocking_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response * data =
      (kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kobuki_ros_interfaces__action__AutoDocking_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  kobuki_ros_interfaces__action__AutoDocking_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kobuki_ros_interfaces__action__AutoDocking_GetResult_Request * data =
      (kobuki_ros_interfaces__action__AutoDocking_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kobuki_ros_interfaces__action__AutoDocking_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kobuki_ros_interfaces__action__AutoDocking_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  kobuki_ros_interfaces__action__AutoDocking_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kobuki_ros_interfaces__action__AutoDocking_GetResult_Response * data =
      (kobuki_ros_interfaces__action__AutoDocking_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kobuki_ros_interfaces__action__AutoDocking_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kobuki_ros_interfaces__action__AutoDocking_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage * data =
      (kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kobuki_ros_interfaces__action__AutoDocking_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
