...
#include "kobuki_ros_interfaces/msg/detail/button_event__rosidl_typesupport_fastrtps_c.h"
...
using _ButtonEvent__ros_msg_type = kobuki_ros_interfaces__msg__ButtonEvent;
...
size_t get_serialized_size_kobuki_ros_interfaces__msg__ButtonEvent(
  const void * untyped_ros_message,
...
static uint32_t _ButtonEvent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kobuki_ros_interfaces__msg__ButtonEvent(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
size_t max_serialized_size_kobuki_ros_interfaces__msg__ButtonEvent(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_kobuki_ros_interfaces__msg__ButtonEvent(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kobuki_ros_interfaces, msg, ButtonEvent)() {
